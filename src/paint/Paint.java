...
public class Paint
{
    ...
    Paint()
    {
       ...
       final JFrame frame = new JFrame("Draw & Paint");
       ...
       // This sets the size of the panel(side panel where rubber and clear is present)
        ...
        ImageIcon rubber = new ImageIcon("../resources/rubber.jpg");
        JButton drawRubber = new JButton(rubber);
        drawRubber.setFocusPainted(false);
        drawRubber.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e) 
            {
                drawPad.Rubber();
        ...
        ImageIcon square = new ImageIcon("../resources/square.jpg");
        ...
        ImageIcon line = new ImageIcon("../resources/line.jpg");
        ...
        ImageIcon pencil = new ImageIcon("../resources/pencil.jpg");
        JButton drawPencil = new JButton(pencil);
        drawPencil.setFocusPainted(true);
        drawPencil.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e) 
            {
                drawPad.Pencil();
    ...
    drawRubber.setPreferredSize(new Dimension(34,30));
    drawPencil.setPreferredSize(new Dimension(34,30));
    ...
    panel.add(drawRubber);
    panel.add(drawPencil);
    panel.add(drawrect);
    ...
    root.setDefaultButton(drawPencil);
 ...
 class PadDraw extends JComponent 
 {
        ...
        public void save(PadDraw panel, File filename)
        {
